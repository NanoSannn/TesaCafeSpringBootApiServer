...
import nvc.it.web_tesa_cafe.service.CustomerService;
...
public class CustomerController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Object> addFavoriteDrink(@PathVariable String id, @RequestBody FavoriteDrink favoriteDrink){
        HashMap<String, Object> map = new HashMap<>();
        map.put("msg", "Update FavoriteDrink Succes!");
        map.put("data", customerService.addFavoriteDrink(id, favoriteDrink));
        return new ResponseEntity<Object>(map, HttpStatus.OK);
    }
